...
# Крсиво для презентации  
ggplot(df, aes(Reconstitution, fill=Transplantation_groups))+
  geom_bar(position = "fill") +
  geom_text(aes(label = ..count..), stat = "count", position = "fill",  size=6)+
  scale_fill_brewer(palette = "GnBu") + theme_classic() +
...
ggplot(df, aes(Reconstitution, fill=Source_sc))+
  geom_bar(position = "fill") +
  geom_text(aes(label = ..count..), stat = "count", position = "fill",  size=6)+
  scale_fill_brewer(palette = "GnBu") + theme_classic() +
   theme(text=element_text(size=20), #change font size of all text
...
ggplot(df, aes(Reconstitution, fill=Sex))+
  geom_bar(position = "fill") +
  geom_text(aes(label = ..count..), stat = "count", position = "fill",  size=6)+
  scale_fill_brewer(palette = "GnBu") + theme_classic() +
   theme(text=element_text(size=20), #change font size of all text
...
ggplot(df, aes(Reconstitution, fill=Restage_on_TKM_point))+
  geom_bar(position = "fill") +
  geom_text(aes(label = ..count..), stat = "count", position = "fill",  size=6)+
  scale_fill_brewer(palette = "GnBu") + theme_classic() +
   theme(text=element_text(size=20), #change font size of all text
...
plot.roc(test_data$Reconstitution, test_model0_nb$yes, legacy.axes=FALSE, percent=TRUE, col="red4", lwd=2, print.auc=TRUE, print.auc.y=30)
plot.roc(test_data$Reconstitution, test_model_day10_nb$yes, percent=TRUE, col="goldenrod", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=25)
plot.roc(test_data$Reconstitution, test_model_day15_nb$yes, percent=TRUE, col="slategrey", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=20)
plot.roc(test_data$Reconstitution, test_model_day20_nb$yes, percent=TRUE, col="seagreen", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=15)
plot.roc(test_data$Reconstitution, test_model_day25_nb$yes, percent=TRUE, col="navy", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=10)
...
legend("bottomright",
       legend=c("Day_0", "Day_10", "Day_15", "Day_20", "Day_25"),
       col=c("red4", "goldenrod", "slategrey", "seagreen", "navy"),
       lwd=5, cex =1, xpd = TRUE)# horiz = TRUE)
...
# ROC plot 1
plot.roc(test_data$Reconstitution, test_model0_xgb$yes, legacy.axes=FALSE, percent=TRUE, col="red4", lwd=2, print.auc=TRUE, print.auc.y=30)
plot.roc(test_data$Reconstitution, test_model_day10_xgb$yes, percent=TRUE, col="goldenrod", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=25)
plot.roc(test_data$Reconstitution, test_model_day15_xgb$yes, percent=TRUE, col="slategrey", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=20)
plot.roc(test_data$Reconstitution, test_model_day20_xgb$yes, percent=TRUE, col="seagreen", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=15)
plot.roc(test_data$Reconstitution, test_model_day25_xgb$yes, percent=TRUE, col="navy", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=10)
...
plot.roc(test_data$Reconstitution, test_model0_knn$yes, legacy.axes=FALSE, percent=TRUE, col="red4", lwd=2, print.auc=TRUE, 
         print.auc.y=30)
plot.roc(test_data$Reconstitution, test_model_day10_knn$yes, percent=TRUE, col="goldenrod", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=25)
plot.roc(test_data$Reconstitution, test_model_day15_knn$yes, percent=TRUE, col="slategrey", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=20)
plot.roc(test_data$Reconstitution, test_model_day20_knn$yes, percent=TRUE, col="seagreen", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=15)
plot.roc(test_data$Reconstitution, test_model_day25_knn$yes, percent=TRUE, col="navy", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=10)
title(main = "KNN", line = 1)


plot.roc(test_data$Reconstitution, test_model0_ranger$yes, legacy.axes=FALSE, percent=TRUE, col="red4", lwd=2, print.auc=TRUE, print.auc.y=30)
plot.roc(test_data$Reconstitution, test_model_day10_ranger$yes, percent=TRUE, col="goldenrod", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=25)
plot.roc(test_data$Reconstitution, test_model_day15_ranger$yes, percent=TRUE, col="slategrey", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=20)
plot.roc(test_data$Reconstitution, test_model_day20_ranger$yes, percent=TRUE, col="seagreen", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=15)
plot.roc(test_data$Reconstitution, test_model_day25_ranger$yes, percent=TRUE, col="navy", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=10)
