...
```{r }
df_raw <- read_excel("reconstitution_v1_enc.xlsx")
str(df_raw)
View(df_raw)
```
...
```{r }
df_raw2 <- read_excel("blood_tests.xlsx")
View(df_raw2)
str(df_raw2)
...
ggplot(combined_some_days, aes(x = Reconstitution, y = PLT)) +
...
ggplot( stat_WBC, aes(x=day_after_HSCT, y=WBC, colour=Reconstitution)) + 
  geom_errorbar(aes(ymin=WBC-se, ymax=WBC+se), width=0.5, size=1) +
  geom_line() +
  geom_point() +
...
ggplot( stat_PLT, aes(x=day_after_HSCT, y=PLT, colour=Reconstitution)) + 
  geom_errorbar(aes(ymin=PLT-se, ymax=PLT+se), width=0.2, size=0.8) +
  geom_line() +
  geom_point() +
  scale_x_continuous(breaks = seq(0, 40, by = 5))+
...
plot.roc(default_tst$Reconstitution, test_model0, legacy.axes=FALSE, percent=TRUE, col="firebrick", lwd=2, print.auc=TRUE)
plot.roc(default_tst$Reconstitution, test_model_day10, percent=TRUE, col="darkorange1", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=40)
plot.roc(default_tst$Reconstitution, test_model_day15, percent=TRUE, col="cyan2", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=30)
plot.roc(default_tst$Reconstitution, test_model_day20, percent=TRUE, col="cornflowerblue", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=20)
plot.roc(default_tst$Reconstitution, test_model_day25, percent=TRUE, col="darkorchid", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=10)

# Add legend
legend("bottomright",
       legend=c("Day_0", "Day_10", "Day_15", "Day_20", "Day_25"),
       col=c("firebrick", "darkorange1", "cyan2", "cornflowerblue", "darkorchid"),
       lwd=4, cex = 1.2, xpd = TRUE)# horiz = TRUE)
...
plot.roc(test_data$Reconstitution, test_model0$yes, legacy.axes=FALSE, percent=TRUE, col="firebrick", lwd=2, print.auc=TRUE)

plot.roc(test_data$Reconstitution, test_model_day10$yes, percent=TRUE, col="darkorange1", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=40)

plot.roc(test_data$Reconstitution, test_model_day15$yes, percent=TRUE, col="forestgreen", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=30)
plot.roc(test_data$Reconstitution, test_model_day20$yes, percent=TRUE, col="cornflowerblue", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=20)
plot.roc(test_data$Reconstitution, test_model_day25$yes, percent=TRUE, col="darkorchid", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=10)

# Add legend
legend("bottomright",
       legend=c("Day_0", "Day_10", "Day_15", "Day_20", "Day_25"),
       col=c("firebrick", "darkorange1", "forestgreen", "cornflowerblue", "darkorchid"),
       lwd=4, cex =1.2, xpd = TRUE)# horiz = TRUE)
title(main = "Models with WBC and PLT")
...
plot.roc(test_data$Reconstitution, test_model0$yes, legacy.axes=FALSE, percent=TRUE, col="firebrick", lwd=2, print.auc=TRUE, print.auc.y=40)

plot.roc(test_data$Reconstitution, test_model_day10$yes, percent=TRUE, col="darkorange1", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=35)

plot.roc(test_data$Reconstitution, test_model_day15$yes, percent=TRUE, col="forestgreen", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=30)
plot.roc(test_data$Reconstitution, test_model_day20$yes, percent=TRUE, col="cornflowerblue", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=25)
plot.roc(test_data$Reconstitution, test_model_day25$yes, percent=TRUE, col="darkorchid", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=20)
...
plot.roc(test_data$Reconstitution, test_model0_ranger$yes, legacy.axes=FALSE, percent=TRUE, col="firebrick", lwd=2, print.auc=TRUE)

plot.roc(test_data$Reconstitution, test_model_day10_ranger$yes, percent=TRUE, col="darkorange1", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=40)

plot.roc(test_data$Reconstitution, test_model_day15_ranger$yes, percent=TRUE, col="forestgreen", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=30)
plot.roc(test_data$Reconstitution, test_model_day20_ranger$yes, percent=TRUE, col="cornflowerblue", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=20)
plot.roc(test_data$Reconstitution, test_model_day25_ranger$yes, percent=TRUE, col="darkorchid", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=10)
...
plot.roc(test_data$Reconstitution, test_model0_knn$yes, legacy.axes=FALSE, percent=TRUE, col="firebrick", lwd=2, print.auc=TRUE)

plot.roc(test_data$Reconstitution, test_model_day10_knn$yes, percent=TRUE, col="darkorange1", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=40)

plot.roc(test_data$Reconstitution, test_model_day15_knn$yes, percent=TRUE, col="forestgreen", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=30)
plot.roc(test_data$Reconstitution, test_model_day20_knn$yes, percent=TRUE, col="cornflowerblue", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=20)
plot.roc(test_data$Reconstitution, test_model_day25_knn$yes, percent=TRUE, col="darkorchid", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=10)
...
plot.roc(test_data$Reconstitution, test_model0_xgb$yes, legacy.axes=FALSE, percent=TRUE, col="firebrick", lwd=2, print.auc=TRUE)
plot.roc(test_data$Reconstitution, test_model_day10_xgb$yes, percent=TRUE, col="darkorange1", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=40)
plot.roc(test_data$Reconstitution, test_model_day15_xgb$yes, percent=TRUE, col="forestgreen", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=30)
plot.roc(test_data$Reconstitution, test_model_day20_xgb$yes, percent=TRUE, col="cornflowerblue", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=20)
plot.roc(test_data$Reconstitution, test_model_day25_xgb$yes, percent=TRUE, col="darkorchid", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=10)
...
model0_nb <- caret::train(Reconstitution ~ Transplantation_groups + Source_sc + Age, 
               data = train_data, 
               trControl = fitControl,
               metric = 'ROC', 
               method = "nb")

model_day10_nb <- caret::train(Reconstitution ~ Transplantation_groups + Source_sc + Age + PLT10 + WBC10, 
               data = train_data, 
               trControl = fitControl,
               metric = 'ROC', 
               method = "nb")
...
model_day15_nb <- caret::train(Reconstitution ~ Transplantation_groups + Source_sc + Age  + PLT15 + WBC15, 
               data = train_data, 
              trControl = fitControl,
               metric = 'ROC', 
               method = "nb")

model_day20_nb <- caret::train(Reconstitution ~ Transplantation_groups + Source_sc + Age + PLT20 + WBC20, 
               data = train_data, 
               trControl = fitControl,
               metric = 'ROC', 
               method = "nb")

model_day25_nb <- caret::train(Reconstitution ~ Transplantation_groups + Source_sc + Age + PLT25 + WBC25, 
               data = train_data, 
               trControl = fitControl,
               metric = 'ROC', 
               method = "nb")
...
test_model0_nb = predict(model0_nb, newdata = test_data, type = "prob", na.action=na.pass) 
test_model_day10_nb = predict(model_day10_nb, newdata = test_data, type = "prob", na.action=na.pass) 
test_model_day15_nb = predict(model_day15_nb, newdata = test_data, type = "prob", na.action=na.pass) 
test_model_day20_nb = predict(model_day20_nb, newdata = test_data, type = "prob", na.action=na.pass) 
test_model_day25_nb = predict(model_day25_nb, newdata = test_data, type = "prob", na.action=na.pass) 


plot.roc(test_data$Reconstitution, test_model0_nb$yes, legacy.axes=FALSE, percent=TRUE, col="firebrick", lwd=2, print.auc=TRUE, print.auc.y=30)
plot.roc(test_data$Reconstitution, test_model_day10_nb$yes, percent=TRUE, col="darkorange1", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=25)
plot.roc(test_data$Reconstitution, test_model_day15_nb$yes, percent=TRUE, col="forestgreen", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=20)
plot.roc(test_data$Reconstitution, test_model_day20_nb$yes, percent=TRUE, col="cornflowerblue", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=15)
plot.roc(test_data$Reconstitution, test_model_day25_nb$yes, percent=TRUE, col="darkorchid", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=10)
...
legend("bottomright",
       legend=c("Day_0", "Day_10", "Day_15", "Day_20", "Day_25"),
       col=c("firebrick", "darkorange1", "forestgreen", "cornflowerblue", "darkorchid"),
       lwd=5, cex =1.2, xpd = TRUE)# horiz = TRUE)
title(main = "Naive Bayes classificator with WBC and PLT")
...
par(mfcol=c(2,2), pty = "s", oma = c(4,1,1,1))

# ROC plot 1
plot.roc(test_data$Reconstitution, test_model0_xgb$yes, legacy.axes=FALSE, percent=TRUE, col="firebrick", lwd=2, print.auc=TRUE, print.auc.y=30)
plot.roc(test_data$Reconstitution, test_model_day10_xgb$yes, percent=TRUE, col="darkorange1", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=25)
plot.roc(test_data$Reconstitution, test_model_day15_xgb$yes, percent=TRUE, col="forestgreen", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=20)
plot.roc(test_data$Reconstitution, test_model_day20_xgb$yes, percent=TRUE, col="cornflowerblue", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=15)
plot.roc(test_data$Reconstitution, test_model_day25_xgb$yes, percent=TRUE, col="darkorchid", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=10)
title(main = "XGBOOST", line = 1)
...
plot.roc(test_data$Reconstitution, test_model_day20_nb$yes, percent=TRUE, col="cornflowerblue", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=15)
plot.roc(test_data$Reconstitution, test_model_day25_nb$yes, percent=TRUE, col="darkorchid", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=10)
title(main = "Naive Bayes", line = 1)

plot.roc(test_data$Reconstitution, test_model0_knn$yes, legacy.axes=FALSE, percent=TRUE, col="firebrick", lwd=2, print.auc=TRUE, 
         print.auc.y=30)
plot.roc(test_data$Reconstitution, test_model_day10_knn$yes, percent=TRUE, col="darkorange1", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=25)
plot.roc(test_data$Reconstitution, test_model_day15_knn$yes, percent=TRUE, col="forestgreen", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=20)
plot.roc(test_data$Reconstitution, test_model_day20_knn$yes, percent=TRUE, col="cornflowerblue", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=15)
plot.roc(test_data$Reconstitution, test_model_day25_knn$yes, percent=TRUE, col="darkorchid", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=10)
title(main = "KNN", line = 1)


plot.roc(test_data$Reconstitution, test_model0_ranger$yes, legacy.axes=FALSE, percent=TRUE, col="firebrick", lwd=2, print.auc=TRUE, print.auc.y=30)
plot.roc(test_data$Reconstitution, test_model_day10_ranger$yes, percent=TRUE, col="darkorange1", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=25)
plot.roc(test_data$Reconstitution, test_model_day15_ranger$yes, percent=TRUE, col="forestgreen", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=20)
plot.roc(test_data$Reconstitution, test_model_day20_ranger$yes, percent=TRUE, col="cornflowerblue", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=15)
plot.roc(test_data$Reconstitution, test_model_day25_ranger$yes, percent=TRUE, col="darkorchid", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=10)
title(main = "Random forest", line = 1)
par(mar=c(0,0,0,0))
par(xpd="NA")
# Add legend
legend(x=200, y = -30,
...
plot.roc(test_data_15_20$Reconstitution, test_model_day15$yes, legacy.axes=FALSE, percent=TRUE, col="firebrick", lwd=2, print.auc=TRUE, print.auc.y=35)
plot.roc(test_data_15_20$Reconstitution, test_model_day16$yes, percent=TRUE, col="darkorange1", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=30)
plot.roc(test_data_15_20$Reconstitution, test_model_day17$yes, percent=TRUE, col="forestgreen", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=25)
plot.roc(test_data_15_20$Reconstitution, test_model_day18$yes, percent=TRUE, col="cornflowerblue", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=20)
plot.roc(test_data_15_20$Reconstitution, test_model_day19$yes, percent=TRUE, col="darkorchid", lwd=2,  add=TRUE, print.auc=TRUE, print.auc.y=15)
...
legend("bottomright",
       ...
       col=c("firebrick", "darkorange1", "forestgreen", "cornflowerblue", "darkorchid", "green"),
       lwd=4, cex =1.2, xpd = TRUE)# horiz = TRUE)
title(main = "Models with WBC and PLT")
...
# Day vs AUC grpaph for days 2 to 30
```{r }
#########################################################################
df_raw2 <- read_excel("./data/raw/blood_tests.xlsx")
...
for (day in 2:29) { 
 ...
 day_1to_30_no_na <- day_1to_30_no_na %>% 
 dplyr::mutate(!!WBC_now := coalesce(!!sym(WBC_now), !!sym(WBC_prev)))    %>%  
 dplyr::mutate(!!PLT_now := coalesce(!!sym(PLT_now), !!sym(PLT_prev))) 
 
} 
view(day_1to_30_no_na)

day_1to_30_no_na <- day_1to_30_no_na %>%
   dplyr::select(!c('PLT1', 'WBC1', 'PLT30', 'WBC30', 'PLT31', 'WBC31'))

dim(na.omit(day_1to_30_no_na))
dim(day_1to_30_no_na)
day_1to_30_no_na = na.omit(day_1to_30_no_na)

table(day_1to_30_no_na$Reconstitution)



#############################################################################################
set.seed(270)
trainIndex <- createDataPartition(day_1to_30_no_na$Reconstitution, 
                                  p = .8, list = FALSE, times = 1)

train_data_1to_30= day_1to_30_no_na[ trainIndex,]
test_data_1to_30  = day_1to_30_no_na[-trainIndex,]

table(train_data_1to_30$Reconstitution)
table(test_data_1to_30$Reconstitution)
##############################################################################################
...
for (day in 2:29){ 
 ...
 WBC_day <- paste0('+ WBC', day)
 PLT_day <- paste0(' + PLT', day)
 params <- paste0('Reconstitution ~ Transplantation_groups + Source_sc + Age ', WBC_day, PLT_day)
 listof_params<-c(listof_params, params)
 listof_days <- c(listof_days, day)
}
listof_params
listof_days
...
compare_var <- c()
for ( i in listof_params) {
  
model <- caret::train(formula(i), 
               data = train_data_1to_30,
               method = 'glm',
               family = "binomial",
               trControl = fitControl,
               metric = 'ROC')

pred <- predict(model, newdata = test_data_1to_30,  type = "prob")
my_roc <- auc(roc(test_data_1to_30$Reconstitution, pred$yes))
compare_var <- cbind(compare_var, my_roc)
}

colnames(compare_var) <- listof_days

final_df <- as.data.frame(t(compare_var))
final_df <- cbind(newColName = as.numeric(rownames(final_df )), final_df )
colnames(final_df) <- c("Day","AUC")

ggplot(data=final_df, aes(x=Day, y=AUC, group=1)) +
  geom_line()+
  geom_point()+
  scale_x_continuous(breaks = seq(0, 40, by = 5))+
  ylab("AUC") + 
  ggtitle("GLM AUC by day") +
  theme_bw() +
 theme(text=element_text(size=20), #change font size of all text
        axis.text=element_text(size=20), #change font size of axis text
        axis.title=element_text(size=20), #change font size of axis titles
